...
export interface CryptoCoffMemberInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addPoint"
      | "approve"
...
export interface CryptoCoffMember extends BaseContract {
  connect(runner?: ContractRunner | null): CryptoCoffMember;
  waitForDeployment(): Promise<this>;

  interface: CryptoCoffMemberInterface;
