    ...
    <Popover>
      <PopoverTrigger asChild className="z-10">
        <Button
          variant="outline"
          className={cn(
            "w-full justify-start text-left font-normal rounded-xl border-[1px] border-[#BDBDBD] bg-[#3D3D3D] hover:bg-[#3D3D3D]",
        ...
        >
          ...
          {date ? (
            <span>
              {isClient ? selectedDateTime.toFormat("DDD HH:mm") : "No Date"}
            </span>
          ) : (
